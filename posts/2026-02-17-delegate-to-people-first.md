---
title: If you can't delegate to people, you can't delegate to AI either
date: 2026-02-17
dek: Most people using AI at work are delegating projects they couldn't delegate to a person, then getting frustrated when the computer can't read their mind.
tags:
  - AI
  - management
  - delegation
...
Last year I started a firm building AI tools for campaigns. The hardest problem is getting people to articulate what they want a project to achieve. Try putting into words [how you actually decide](https://foundationcapital.com/context-graphs-ais-trillion-dollar-opportunity/) on a client's messaging strategy and the research projects you need to support it. It's probably incoherent. It contradicts itself. It relies on unspoken norms we expect staff to absorb osmotically over years. We get away with it because humans fill gaps with intuition.
...
Jaya Gupta and Ashu Garg from Foundation Capital call this the [context graph](https://foundationcapital.com/context-graphs-ais-trillion-dollar-opportunity/) problem: the gap between what professionals know and what they've written down. Your AI isn't in the conference room when you have the idea. It doesn't have access to the Signal thread, the strategy doc you read last week, or the vibes in your heart and head. That's the gap it falls into.

[Ethan Mollick](https://www.oneusefulthing.org/p/management-as-ai-superpower) gets there differently: "In figuring out how to give these instructions to AI, it turns out you are basically reinventing management." What does "done" look like? Teams defer these hard definitions because urgency doesn't arrive until the polling memo is due. Humans muddle through because they can course-correct late. A language model can't. It just goes and does the thing, and without a committed definition of done, it falls straight into the gap. The user expects magic and receives nonsense.
